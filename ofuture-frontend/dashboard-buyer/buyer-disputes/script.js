// ============================================================
// Disputes List Page - Buyer Dashboard
// ============================================================
    ...
    <div class="card dispute-card">
      <div>
        ...
        <div class="dispute-info">
          ...
          <div class="dispute-info-item">
            ...
            <span>${dispute.seller_name || 'N/A'}</span>
          </div>
          <div class="dispute-info-item">
      ...
      <div class="dispute-card-status">
        ...
        <div class="dispute-actions">
          <a href="../buyer-dispute-detail/index.html?id=${dispute.id}" class="btn btn-primary" style="text-decoration: none; display: inline-block;">
            Xem chi tiết
          </a>
        </div>
      </div>
